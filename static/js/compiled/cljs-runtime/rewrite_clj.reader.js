...
var len__4736__auto___56932 = arguments.length;
var i__4737__auto___56933 = (0);
while(true){
if((i__4737__auto___56933 < len__4736__auto___56932)){
args__4742__auto__.push((arguments[i__4737__auto___56933]));

var G__56935 = (i__4737__auto___56933 + (1));
i__4737__auto___56933 = G__56935;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq56839){
var G__56840 = cljs.core.first(seq56839);
var seq56839__$1 = cljs.core.next(seq56839);
var G__56841 = cljs.core.first(seq56839__$1);
var seq56839__$2 = cljs.core.next(seq56839__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56840,G__56841,seq56839__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__56896_SHARP_){
return (((p1__56896_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__56896_SHARP_)));
...
var G__56949 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__56950 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__56949;
vs = G__56950;
continue;
} else {

...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56455,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56455,else__4383__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56454){
var self__ = this;
var G__56454__$1 = this;
return (new cljs.core.RecordIter((0),G__56454__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56456,other56457){
var self__ = this;
var this56456__$1 = this;
return (((!((other56457 == null)))) && ((this56456__$1.constructor === other56457.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56456__$1.tag,other56457.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56456__$1.prefix,other56457.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56456__$1.sym,other56457.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56456__$1.children,other56457.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56456__$1.__extmap,other56457.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56454){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56494 = cljs.core.keyword_identical_QMARK_;
var expr__56495 = k__4388__auto__;
if(cljs.core.truth_((pred__56494.cljs$core$IFn$_invoke$arity$2 ? pred__56494.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__56495) : pred__56494.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__56495)))){
return (new rewrite_clj.node.quote.QuoteNode(G__56454,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56494.cljs$core$IFn$_invoke$arity$2 ? pred__56494.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__56495) : pred__56494.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__56495)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__56454,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56494.cljs$core$IFn$_invoke$arity$2 ? pred__56494.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__56495) : pred__56494.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__56495)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__56454,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56494.cljs$core$IFn$_invoke$arity$2 ? pred__56494.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__56495) : pred__56494.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__56495)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__56454,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56454),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56454){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__56454,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__56470){
var extmap__4419__auto__ = (function (){var G__56504 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56470,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__56470)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56504);
} else {
return G__56504;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__56470),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__56470),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__56470),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__56470),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__56595 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__56595;
continue;
}
break;
...
var G__56596 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__56596;
continue;
}
break;
...
var G__56597 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__56597;
continue;
}
break;
...
var G__56598 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__56598;
continue;
}
break;

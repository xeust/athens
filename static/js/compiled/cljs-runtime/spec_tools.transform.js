...
if((x instanceof cljs.core.Keyword)){
var G__89654 = spec;
var G__89655 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__89654,G__89655) : f.call(null,G__89654,G__89655));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__89657 = spec;
var G__89658 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__89657,G__89658) : f.call(null,G__89657,G__89658));
} else {
return x;
...
}catch (e89659){if((e89659 instanceof Error)){
var ___$1 = e89659;
return x;
} else {
throw e89659;
...
}catch (e89660){if((e89660 instanceof Error)){
var ___$1 = e89660;
return x;
} else {
throw e89660;
...
}catch (e89661){if((e89661 instanceof Error)){
var ___$1 = e89661;
return x;
} else {
throw e89661;
...
}catch (e89662){if((e89662 instanceof Error)){
var ___$1 = e89662;
return x;
} else {
throw e89662;
...
}catch (e89663){if((e89663 instanceof Error)){
var ___$1 = e89663;
return x;
} else {
throw e89663;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__89669,x){
var map__89670 = p__89669;
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89670__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__89672,x){
var map__89673 = p__89672;
var map__89673__$1 = (((((!((map__89673 == null))))?(((((map__89673.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89673.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89673):map__89673);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89673__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__89675,x){
var map__89676 = p__89675;
var map__89676__$1 = (((((!((map__89676 == null))))?(((((map__89676.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89676.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89676):map__89676);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89676__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));

...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__57386){
var vec__57387 = p__57386;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57387,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57376_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq57377){
var G__57378 = cljs.core.first(seq57377);
var seq57377__$1 = cljs.core.next(seq57377);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57378,seq57377__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__57393,p__57394){
var map__57395 = p__57393;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57395__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57395__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57395__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57395__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__57396 = p__57394;
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57396__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57396__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
if((r >= row)){
if((r <= end_row)){
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57408_SHARP_){
var and__4115__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__57408_SHARP_) : p_QMARK_.call(null,p1__57408_SHARP_));
if(cljs.core.truth_(and__4115__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__57408_SHARP_)),pos);
} else {
...
var G__57414 = zloc;
var G__57414__$1 = (((G__57414 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__57414) : f.call(null,G__57414)));
if((G__57414__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__57414__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__57415_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57415_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__57426_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__57426_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__57447_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__57447_SHARP_),v);
}));

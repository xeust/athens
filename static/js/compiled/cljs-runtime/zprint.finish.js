...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__55900_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__55900_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__55900_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__55903){
var vec__55904 = p__55903;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55904,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55904,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__55907,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55908__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55908__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55908__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__55916 = (function (){var or__4126__auto__ = color;
...
var fexpr__55915 = (function (){var G__55917 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__55917) : style_map.call(null,G__55917));
})();
return (fexpr__55915.cljs$core$IFn$_invoke$arity$1 ? fexpr__55915.cljs$core$IFn$_invoke$arity$1(G__55916) : fexpr__55915.call(null,G__55916));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__55918){
var vec__55919 = p__55918;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55919,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55919,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55919,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__55923){
var vec__55924 = p__55923;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55924,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55924,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55924,(2),null);
...
var G__56095 = cljs.core.next(ssv);
var G__56096 = (this_ssv == null);
var G__56097 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__56098 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__56095;
doing_nil_QMARK_ = G__56096;
last_elide = G__56097;
out = G__56098;
continue;
}
...
var vec__55938 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55938,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55938,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55938,(2),null);
...
var G__56104 = cljs.core.next(remaining_cvec);
var G__56105 = new_idx;
var G__56106 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__56104;
idx = G__56105;
out = G__56106;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__55962,cursor_vec){
var vec__55963 = p__55962;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55963,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55963,(1),null);
var focus_vec = vec__55963;
...
var vec__55966 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55966,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55966,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__55970){
var vec__55971 = p__55970;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55971,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55971,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__55994,existing_count){
var vec__55997 = p__55994;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55997,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55997,(1),null);
...
return cljs.core.filterv((function (p1__55979_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__55979_SHARP_))));
...
var vec__56033 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56033,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56033,(1),null);
var cvec_element = vec__56033;
if((cvec_element == null)){
var G__56123 = cljs.core.next(cvec_nl);
var G__56124 = (idx + (1));
var G__56125 = start;
var G__56126 = out;
cvec_nl = G__56123;
...
var G__56127 = cljs.core.next(cvec_nl);
var G__56128 = (idx + (1));
var G__56129 = idx;
var G__56130 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__56127;
idx = G__56128;
start = G__56129;
out = G__56130;
...
var G__56131 = cljs.core.next(cvec_nl);
var G__56132 = (idx + (1));
var G__56133 = (idx + (1));
var G__56134 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__56131;
idx = G__56132;
start = G__56133;
out = G__56134;
...
var G__56136 = cljs.core.next(cvec_nl);
var G__56137 = (idx + (1));
var G__56138 = idx;
var G__56139 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__56136;
idx = G__56137;
start = G__56138;
out = G__56139;
...
var G__56140 = cljs.core.next(cvec_nl);
var G__56141 = (idx + (1));
var G__56142 = start;
var G__56143 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__56140;
idx = G__56141;
start = G__56142;
out = G__56143;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__56039_SHARP_,p2__56038_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__56038_SHARP_)){
return cljs.core.reduced(p1__56039_SHARP_);
} else {
return (p1__56039_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__56045,p__56046){
var vec__56049 = p__56045;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56049,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56049,(1),null);
var vec__56052 = p__56046;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56052,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56052,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__56074,cvec,focus_vec){
...
var map__56079 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56076__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56079__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56079__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56079__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56071_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__56071_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);

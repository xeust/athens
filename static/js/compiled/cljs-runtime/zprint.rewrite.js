...
var G__58100 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__58100;
continue;
} else {
var G__58101 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__58101;
continue;
}
} else {
var G__58102 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__58102;
continue;
}
}
...
var G__58084 = zloc;
var G__58085 = (function (){var G__58087 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__58088 = zloc;
var G__58088__$1 = (((G__58088 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__58088) : rewrite_clj.zip.node.call(null,G__58088)));
if((G__58088__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__58088__$1) : zprint.zutil.edn_STAR_.call(null,G__58088__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__58087) : rewrite_clj.zip.root.call(null,G__58087));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__58084,G__58085) : rewrite_clj.zip.replace.call(null,G__58084,G__58085));
});
/**
...
var G__58105 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__58105;
continue;
}
break;
...
var G__58106 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__58107 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__58106;
out = G__58107;
continue;
} else {
...
var G__58112 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__58113 = cljs.core.next(new_loc);
var G__58114 = replaced_loc;
nloc = G__58112;
new_loc = G__58113;
last_loc = G__58114;
continue;
...
return zprint.rewrite.sort_val((function (){var G__58092 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__58092) : rewrite_clj.zip.down.call(null,G__58092));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__58096_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__58096_SHARP_) : rewrite_clj.zip.tag.call(null,p1__58096_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__58096_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__58096_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));

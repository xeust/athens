...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq49983){
var G__49984 = cljs.core.first(seq49983);
var seq49983__$1 = cljs.core.next(seq49983);
var G__49985 = cljs.core.first(seq49983__$1);
var seq49983__$2 = cljs.core.next(seq49983__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49984,G__49985,seq49983__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50022_SHARP_){
return (!((cljs.core.meta(p1__50022_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50036__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e50040){var _e__48914__auto__ = e50040;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e50042){var _e__48914__auto__ = e50042;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__50054 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__50055 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__50055);

try{var map__50056 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50056__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__50054);
}});
...
var temp__5733__auto___50092 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___50092)){
var managed_print_level_50093 = temp__5733__auto___50092;
var _STAR_print_level_STAR__orig_val__50060_50094 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__50061_50095 = managed_print_level_50093;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__50061_50095);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__50058_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__50058_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__50060_50094);
}} else {
job_fn();
}

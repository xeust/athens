...
return [(function (){var pred__58937 = cljs.core.instance_QMARK_;
var expr__58938 = reactive_val;
if(cljs.core.truth_((pred__58937.cljs$core$IFn$_invoke$arity$2 ? pred__58937.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__58938) : pred__58937.call(null,reagent.ratom.RAtom,expr__58938)))){
return "ra";
} else {
if(cljs.core.truth_((pred__58937.cljs$core$IFn$_invoke$arity$2 ? pred__58937.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__58938) : pred__58937.call(null,reagent.ratom.RCursor,expr__58938)))){
return "rc";
} else {
if(cljs.core.truth_((pred__58937.cljs$core$IFn$_invoke$arity$2 ? pred__58937.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__58938) : pred__58937.call(null,reagent.ratom.Reaction,expr__58938)))){
return "rx";
} else {
if(cljs.core.truth_((pred__58937.cljs$core$IFn$_invoke$arity$2 ? pred__58937.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__58938) : pred__58937.call(null,reagent.ratom.Track,expr__58938)))){
return "tr";
} else {
return "other";
}

...
spanstatus_1.SpanStatus.Ok};Span.prototype.finish=function(endTimestamp){this.endTimestamp="number"===typeof endTimestamp?endTimestamp:utils_1.timestampWithMs()};Span.prototype.toTraceparent=function(){var sampledString="";void 0!==this.sampled&&(sampledString=this.sampled?"-1":"-0");return this.traceId+"-"+this.spanId+sampledString};Span.prototype.getTraceContext=function(){return utils_1.dropUndefinedKeys({data:0<Object.keys(this.data).length?this.data:void 0,description:this.description,op:this.op,
parent_span_id:this.parentSpanId,span_id:this.spanId,status:this.status,tags:0<Object.keys(this.tags).length?this.tags:void 0,trace_id:this.traceId})};Span.prototype.toJSON=function(){return utils_1.dropUndefinedKeys({data:0<Object.keys(this.data).length?this.data:void 0,description:this.description,op:this.op,parent_span_id:this.parentSpanId,span_id:this.spanId,start_timestamp:this.startTimestamp,status:this.status,tags:0<Object.keys(this.tags).length?this.tags:void 0,timestamp:this.endTimestamp,
trace_id:this.traceId})};return Span}();exports.Span=global}

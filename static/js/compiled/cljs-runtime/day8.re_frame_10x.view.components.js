...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__56174){
var map__56175 = p__56174;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56175__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56175__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56175__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56175__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56175__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__56184){
var vec__56185 = p__56184;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56185,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56185,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56182_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__56182_SHARP_,/:/);
...
var len__4736__auto___56451 = arguments.length;
var i__4737__auto___56452 = (0);
while(true){
if((i__4737__auto___56452 < len__4736__auto___56451)){
args__4742__auto__.push((arguments[i__4737__auto___56452]));

var G__56453 = (i__4737__auto___56452 + (1));
i__4737__auto___56452 = G__56453;
continue;
} else {
}
break;
...
var previous_config__56162__auto__ = devtools.prefs.get_prefs();
var prefs__56163__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__56163__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__56163__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__56163__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__56162__auto__);
}}));

(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq56189){
var G__56190 = cljs.core.first(seq56189);
var seq56189__$1 = cljs.core.next(seq56189);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56190,seq56189__$1);
}));
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq56192){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56192));
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56461 = arguments.length;
var i__4737__auto___56462 = (0);
while(true){
if((i__4737__auto___56462 < len__4736__auto___56461)){
args__4742__auto__.push((arguments[i__4737__auto___56462]));

var G__56463 = (i__4737__auto___56462 + (1));
i__4737__auto___56462 = G__56463;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq56194){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56194));
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56464 = arguments.length;
var i__4737__auto___56465 = (0);
while(true){
if((i__4737__auto___56465 < len__4736__auto___56464)){
args__4742__auto__.push((arguments[i__4737__auto___56465]));

var G__56466 = (i__4737__auto___56465 + (1));
i__4737__auto___56465 = G__56466;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq56197){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56197));
}));
...
var expanded_QMARK_ = (function (){var G__56202 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__56202) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__56202));
})();
...
var G__56205 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__56205) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.call(null,G__56205));
...
})())?(function (){var G__56207 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__56208 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__56207,G__56208) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__56207,G__56208));
})():(function (){var G__56209 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__56210 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__56209,G__56210) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__56209,G__56210));
})())], null);
});
});
/**
...
var vec__56216 = jsonml;
var seq__56217 = cljs.core.seq(vec__56216);
var first__56218 = cljs.core.first(seq__56217);
var seq__56217__$1 = cljs.core.next(seq__56217);
var tag_name = first__56218;
var first__56218__$1 = cljs.core.first(seq__56217__$1);
var seq__56217__$2 = cljs.core.next(seq__56217__$1);
var attributes = first__56218__$1;
var children = seq__56217__$2;
...
var G__56224 = child;
var G__56225 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__56224,G__56225) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__56224,G__56225));
})),children);
} else {
...
var expanded_QMARK_ = (function (){var G__56226 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__56226) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__56226));
})();
...
var G__56227 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__56227) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.call(null,G__56227));
...
var args__4742__auto__ = [];
var len__4736__auto___56467 = arguments.length;
var i__4737__auto___56468 = (0);
while(true){
if((i__4737__auto___56468 < len__4736__auto___56467)){
args__4742__auto__.push((arguments[i__4737__auto___56468]));

var G__56469 = (i__4737__auto___56468 + (1));
i__4737__auto___56468 = G__56469;
continue;
} else {
}
break;
...
(day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__56379){
var vec__56380 = p__56379;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56380,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (data__$1){
...
/** @this {Function} */
(day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq56231){
var G__56246 = cljs.core.first(seq56231);
var seq56231__$1 = cljs.core.next(seq56231);
var G__56247 = cljs.core.first(seq56231__$1);
var seq56231__$2 = cljs.core.next(seq56231__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56246,G__56247,seq56231__$2);
}));

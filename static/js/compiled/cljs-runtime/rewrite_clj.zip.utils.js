...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__57238,k,f){
var vec__57240 = p__57238;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57240,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57240,(1),null);
var loc = vec__57240;
...
var G__57360 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__57360;
continue;
}
break;
...
var G__57366 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__57366;
continue;
} else {
return zloc__$1;
...
var G__57368 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__57368;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__57258){
var vec__57259 = p__57258;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57259,(0),null);
var map__57262 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57259,(1),null);
...
var path = map__57262__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57262__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__57259;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__57280){
var vec__57288 = p__57280;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57288,(0),null);
var map__57291 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57288,(1),null);
...
var path = map__57291__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57291__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__57288;
if(cljs.core.seq(r)){
...
var vec__57298 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57298,(0),null);
...
var path = map__57301__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57301__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57301__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57301__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57301__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){

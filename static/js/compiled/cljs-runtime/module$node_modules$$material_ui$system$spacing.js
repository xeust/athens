...
cssProperty){if("string"===typeof propValue)var JSCompiler_inline_result=propValue;else JSCompiler_inline_result=transformer(Math.abs(propValue)),JSCompiler_inline_result=0<=propValue?JSCompiler_inline_result:"number"===typeof JSCompiler_inline_result?-JSCompiler_inline_result:"-".concat(JSCompiler_inline_result);acc[cssProperty]=JSCompiler_inline_result;return acc},{})}}function spacing(props){var transformer=createUnarySpacing(props.theme);return Object.keys(props).map(function(prop){if(-1===spacingKeys.indexOf(prop))return null;
var cssProperties=getCssProperties(prop);cssProperties=getStyleFromPropValue(cssProperties,transformer);prop=props[prop];return(0,_breakpoints.handleBreakpoints)(props,prop,cssProperties)}).reduce(_merge.default,{})}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.createUnarySpacing=createUnarySpacing;exports.default=void 0;var _slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),

...
var vec__89037 = cljs.core.rest(expr);
var seq__89038 = cljs.core.seq(vec__89037);
var first__89039 = cljs.core.first(seq__89038);
var seq__89038__$1 = cljs.core.next(seq__89038);
var vec__89040 = first__89039;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89040,(0),null);
var form = seq__89038__$1;
...
var G__89057 = x;
var G__89057__$1 = (((G__89057 == null))?null:spec_tools.impl.polish(G__89057));
var G__89057__$2 = (((G__89057__$1 == null))?null:cljs.core.name(G__89057__$1));
if((G__89057__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__89057__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__89058 = x;
var G__89058__$1 = (((G__89058 == null))?null:cljs.core.name(G__89058));
if((G__89058__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__89058__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__89059){
...
var data = map__89060__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89060__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89060__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89060__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89060__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__89062){
var map__89063 = p__89062;
...
var data = map__89063__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89063__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89063__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__89065 = data;
var G__89065__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__89065,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__89065);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__89065__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__89065__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__89073 = form;
var G__89073__$1 = (((G__89073 == null))?null:cljs.core.rest(G__89073));
if((G__89073__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__89073__$1);
}
})();
var G__89075 = m;
var G__89075__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__89075,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__89067_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__89067_SHARP_)));
})):G__89075);
var G__89075__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__89075__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__89068_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__89068_SHARP_)));
})):G__89075__$1);
var G__89075__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__89075__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__89069_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__89069_SHARP_));
})):G__89075__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__89075__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__89076 = (function (){var G__89077 = form;
var G__89077__$1 = (((G__89077 == null))?null:cljs.core.rest(G__89077));
if((G__89077__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__89077__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89076__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89076__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89076__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89076__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__89079 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__89079) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__89081 = form;
var G__89081__$1 = (((G__89081 == null))?null:cljs.core.seq(G__89081));
var G__89081__$2 = (((G__89081__$1 == null))?null:cljs.core.first(G__89081__$1));
if((G__89081__$2 == null)){
return null;
} else {
var fexpr__89082 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__89082.cljs$core$IFn$_invoke$arity$1 ? fexpr__89082.cljs$core$IFn$_invoke$arity$1(G__89081__$2) : fexpr__89082.call(null,G__89081__$2));
}
})():null));
});
/**
...
var len__4736__auto___89129 = arguments.length;
var i__4737__auto___89130 = (0);
while(true){
if((i__4737__auto___89130 < len__4736__auto___89129)){
args__4742__auto__.push((arguments[i__4737__auto___89130]));

var G__89133 = (i__4737__auto___89130 + (1));
i__4737__auto___89130 = G__89133;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq89083){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq89083));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__89086){
var vec__89087 = p__89086;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89087,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89087,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__89098){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89099__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89099__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89099__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89099__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__89096_SHARP_){
return cljs.core.map_QMARK_(p1__89096_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__89097_SHARP_){
return cljs.core.contains_QMARK_(p1__89097_SHARP_,x);
});
}),req_keys));

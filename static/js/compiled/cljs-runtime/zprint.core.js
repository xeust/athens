...
var vec__60436 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__60442 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60442,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60442,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60436,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60436,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__60450){
var vec__60451 = p__60450;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60451,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60451,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60454,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60454,(1),null);
...
var vec__60462 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60462,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60462,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60462,(2),null);
var vec__60465 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60465,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60465,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60465,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__60477){
var vec__60479 = p__60477;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60479,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60479,(1),null);
...
var len__4736__auto___60643 = arguments.length;
var i__4737__auto___60644 = (0);
while(true){
if((i__4737__auto___60644 < len__4736__auto___60643)){
args__4742__auto__.push((arguments[i__4737__auto___60644]));

var G__60645 = (i__4737__auto___60644 + (1));
i__4737__auto___60644 = G__60645;
continue;
} else {
}
break;
...
var vec__60488 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60488,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60488,(1),null);
...
var G__60491 = zprint.core.parse_string_all_options(rest_options);
var G__60492 = zprint.core.zprint_str_internal;
var G__60493 = ":parse-string-all? call";
var G__60494 = (function (){var G__60495 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__60495) : zprint.zutil.edn_STAR_.call(null,G__60495));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__60491,G__60492,G__60493,G__60494) : zprint.core.process_multiple_forms.call(null,G__60491,G__60492,G__60493,G__60494));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__60497 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60497,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60497,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq60483){
var G__60484 = cljs.core.first(seq60483);
var seq60483__$1 = cljs.core.next(seq60483);
var G__60485 = cljs.core.first(seq60483__$1);
var seq60483__$2 = cljs.core.next(seq60483__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60484,G__60485,seq60483__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___60658 = arguments.length;
var i__4737__auto___60659 = (0);
while(true){
if((i__4737__auto___60659 < len__4736__auto___60658)){
args__4742__auto__.push((arguments[i__4737__auto___60659]));

var G__60660 = (i__4737__auto___60659 + (1));
i__4737__auto___60659 = G__60660;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq60507){
var G__60508 = cljs.core.first(seq60507);
var seq60507__$1 = cljs.core.next(seq60507);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60508,seq60507__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___60669 = arguments.length;
var i__4737__auto___60670 = (0);
while(true){
if((i__4737__auto___60670 < len__4736__auto___60669)){
args__4742__auto__.push((arguments[i__4737__auto___60670]));

var G__60671 = (i__4737__auto___60670 + (1));
i__4737__auto___60670 = G__60671;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq60512){
var G__60513 = cljs.core.first(seq60512);
var seq60512__$1 = cljs.core.next(seq60512);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60513,seq60512__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___60675 = arguments.length;
var i__4737__auto___60677 = (0);
while(true){
if((i__4737__auto___60677 < len__4736__auto___60675)){
args__4742__auto__.push((arguments[i__4737__auto___60677]));

var G__60678 = (i__4737__auto___60677 + (1));
i__4737__auto___60677 = G__60678;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq60514){
var G__60515 = cljs.core.first(seq60514);
var seq60514__$1 = cljs.core.next(seq60514);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60515,seq60514__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___60679 = arguments.length;
var i__4737__auto___60680 = (0);
while(true){
if((i__4737__auto___60680 < len__4736__auto___60679)){
args__4742__auto__.push((arguments[i__4737__auto___60680]));

var G__60681 = (i__4737__auto___60680 + (1));
i__4737__auto___60680 = G__60681;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq60519){
var G__60520 = cljs.core.first(seq60519);
var seq60519__$1 = cljs.core.next(seq60519);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__60520,seq60519__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__60535,form){
var vec__60536 = p__60535;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60536,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60536,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60536,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60536,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__60539 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60539,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60539,(1),null);
...
var forms = (function (){var G__60561 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__60561) : zprint.zutil.edn_STAR_.call(null,G__60561));
})();

...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_52141 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_52141(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_52144 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_52144(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52145 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_52145(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52146 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_52146(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52147 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_52147(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52151 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_52151(reader);
}
});
...
var G__52156 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__52157 = s.append(c);
c = G__52156;
s = G__52157;
continue;
}

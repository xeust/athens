...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__78616 = goog.object.get(JSJodaLocale,"Locale");
if((G__78616 == null)){
return null;
} else {
return goog.object.get(G__78616,"US");
}
}catch (e78615){if((e78615 instanceof Error)){
var e = e78615;
return null;
} else {
throw e78615;

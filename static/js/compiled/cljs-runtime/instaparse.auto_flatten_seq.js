...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_81053 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_81053(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_81054 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_81054(self);
}
});
...
var G__81056 = n__$1;
var G__81057 = y;
var G__81058 = cljs.core.imul(z,z);
n = G__81056;
y = G__81057;
z = G__81058;
continue;
...
var G__81065 = n__$1;
var G__81066 = cljs.core.imul(z,y);
var G__81067 = cljs.core.imul(z,z);
n = G__81065;
y = G__81066;
z = G__81067;
continue;
...
var G__81068 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__81069 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__81068;
index__$1 = G__81069;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__80924 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__80924) : instaparse.auto_flatten_seq.true_count.call(null,G__80924));
})() - (1)))){
...
var G__81070 = v;
var G__81071 = cljs.core.pop(index);
v = G__81070;
index = G__81071;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__81078 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__81079 = cljs.core.next(coll__$1);
unmixed_hash = G__81078;
coll__$1 = G__81079;
continue;
} else {
return unmixed_hash;
...
var G__81085 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__81086 = cljs.core.next(v);
acc = G__81085;
v = G__81086;
continue;
} else {
var G__81087 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__81088 = cljs.core.next(v);
acc = G__81087;
v = G__81088;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_81102 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_81102(self);
}
});
...
var self__ = this;
var self__ = this;
var G__81051 = (arguments.length - (1));
switch (G__81051) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args81007){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args81007)));
}));

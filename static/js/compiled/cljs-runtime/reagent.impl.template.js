...
var G__58549 = o;
goog.object.set(G__58549,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__58551 = o;
goog.object.set(G__58551,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__58553 = props;
var G__58553__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58553,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__58553);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58553__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__58553__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__58554 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58554,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__58554;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__58560){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58561__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__58576_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__58576_SHARP_);
}));
} else {
return null;
}
...
var vec__58581 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58581,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58581,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58581,(2),null);
...
var temp__5739__auto___58630 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___58630 == null)){
} else {
var key_58631 = temp__5739__auto___58630;
(jsprops.key = key_58631);
}
...
var temp__5739__auto___58632 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___58632 == null)){
} else {
var key_58633 = temp__5739__auto___58632;
(jsprops.key = key_58633);
}
...
var G__58587 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__58587) : reagent.impl.template.as_element.call(null,G__58587));
} else {
var temp__5739__auto___58636 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___58636 == null)){
} else {
var key_58637 = temp__5739__auto___58636;
(jsprops.key = key_58637);
}
...
var G__58589 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__58589)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58589)){
return x;
} else {
...
var len__4736__auto___58638 = arguments.length;
var i__4737__auto___58639 = (0);
while(true){
if((i__4737__auto___58639 < len__4736__auto___58638)){
args__4742__auto__.push((arguments[i__4737__auto___58639]));

var G__58640 = (i__4737__auto___58639 + (1));
i__4737__auto___58639 = G__58640;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq58591){
var G__58592 = cljs.core.first(seq58591);
var seq58591__$1 = cljs.core.next(seq58591);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58592,seq58591__$1);
}));
...
break;
default:
var G__58642 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__58642;
continue;
...
var ctx = ({});
var vec__58606 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58606,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58606,(1),null);
...
var G__58609 = (cljs.core.count(argv) - first_child);
switch (G__58609) {
case (0):

...
var G__57484 = (function (){var G__57485 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__57485) : f.call(null,G__57485));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__57484) : rewrite_clj.node.coerce.call(null,G__57484));
});
/**
...
var len__4736__auto___57515 = arguments.length;
var i__4737__auto___57516 = (0);
while(true){
if((i__4737__auto___57516 < len__4736__auto___57515)){
args__4742__auto__.push((arguments[i__4737__auto___57516]));

var G__57518 = (i__4737__auto___57516 + (1));
i__4737__auto___57516 = G__57518;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__57486_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__57486_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq57487){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57488,G__57489,seq57487__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__57495 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__57495) : str_fn.call(null,G__57495));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__57496 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__57496) : str_fn.call(null,G__57496));
})()):null)));
...
var G__57504 = rewrite_clj.zip.base.tag(zloc);
var G__57504__$1 = (((G__57504 instanceof cljs.core.Keyword))?G__57504.fqn:null);
switch (G__57504__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__57502_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57502_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__57503_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57503_SHARP_)].join('');
}));
}
}));
...
var G__57508 = rewrite_clj.zip.base.tag(zloc);
var G__57508__$1 = (((G__57508 instanceof cljs.core.Keyword))?G__57508.fqn:null);
switch (G__57508__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__57506_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57506_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57508__$1)].join('')));

...
var G__57537 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__57537__$1 = (((G__57537 == null))?null:cljs.core.iterate((function (loc){
...
var G__57537__$2 = (((G__57537__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__57537__$1));
var G__57537__$3 = (((G__57537__$2 == null))?null:cljs.core.last(G__57537__$2));
if((G__57537__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__57537__$3);
}
} else {
return zloc;
}
...
var G__57556 = rewrite_clj.zip.move.right(v);
var G__57557 = rewrite_clj.zip.move.up(v);
loc = G__57556;
parent = G__57557;
continue;
} else {
var G__57558 = rewrite_clj.zip.move.right(v0);
var G__57559 = parent;
loc = G__57558;
parent = G__57559;
continue;
...
var G__57560 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__57561 = rewrite_clj.zip.move.up(v);
loc = G__57560;
parent = G__57561;
continue;
} else {
var G__57562 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__57563 = parent;
loc = G__57562;
parent = G__57563;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__57545 = zloc;
var G__57545__$1 = (((G__57545 == null))?null:rewrite_clj.zip.move.down(G__57545));
var G__57545__$2 = (((G__57545__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__57545__$1,k));
if((G__57545__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__57545__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__57546 = rewrite_clj.zip.move.down(zloc);
var G__57546__$1 = (((G__57546 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__57546));
if((G__57546__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__57546__$1);
}
})(),k);
}
});

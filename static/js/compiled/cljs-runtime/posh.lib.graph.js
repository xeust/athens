...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(graph,k,(function (p1__73317_SHARP_){
return cljs.core.disj.cljs$core$IFn$_invoke$arity$2(p1__73317_SHARP_,dep_k);
}));
});
...
var map__73322 = temp__5733__auto__;
var map__73322__$1 = (((((!((map__73322 == null))))?(((((map__73322.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73322.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__73322):map__73322);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73322__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var outputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__73322__$1,new cljs.core.Keyword(null,"outputs","outputs",-1896513034));

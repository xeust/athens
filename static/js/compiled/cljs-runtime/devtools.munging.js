...
var o49470 = temp__5733__auto__;
var temp__5733__auto____$1 = (o49470["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o49471 = temp__5733__auto____$1;
return (o49471["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__48882__auto__ = f;
return (o__48882__auto__["toString"]).call(o__48882__auto__);
} else {
return "";
}
}catch (e49473){var _ = e49473;
return "";
}});
...
try{var o__48882__auto___49839 = t;
(o__48882__auto___49839["cljs$lang$ctorPrWriter"]).call(o__48882__auto___49839,t,writer);
}catch (e49480){var __49840 = e49480;
}
...
var char_code = (function (){var o__48882__auto__ = (new String(char$));
return (o__48882__auto__["charCodeAt"]).call(o__48882__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__48882__auto__ = String;
return (o__48882__auto__["fromCharCode"]).call(o__48882__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__49490 = num_code;
switch (G__49490) {
case (1):
return (185);
...
var o__48882__auto__ = String;
return (o__48882__auto__["fromCharCode"]).call(o__48882__auto__,superscript_code);
});
/**
...
}catch (e49492){var _e__48914__auto__ = e49492;
return false;
}})())){
...
var vec__49493 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49493,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o49500 = temp__5733__auto__;
var temp__5733__auto____$1 = (o49500["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o49501 = temp__5733__auto____$1;
return (o49501["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__49515){
var vec__49516 = p__49515;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49516,(0),null);
...
var G__49860 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__49861 = cljs.core.butlast(remaining_tokens);
name_tokens = G__49860;
remaining_tokens = G__49861;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq49503){
...
var vec__49526 = cljs.core.split_with((function (p1__49525_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49525_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49526,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49526,(1),null);
...
var vec__49539 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49539,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49539,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__49865 = cljs.core.rest(remaining_tokens);
var G__49866 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__49865;
name_tokens = G__49866;
continue;
} else {
...
var vec__49556 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49556,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49556,(1),null);
var vec__49559 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49559,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49559,(1),null);
var vec__49562 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49562,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49562,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49562,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49562,(3),null);
...
var vec__49604 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49604,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__49610 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49610,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49610,(1),null);
var vec__49613 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49613,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49613,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__49623 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__49623) : devtools.munging.parse_fn_info_deep.call(null,G__49623));
})()));
}
} else {
return fn_info;
...
var G__49885 = (arity + (1));
var G__49886 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__49662){
var vec__49663 = p__49662;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49663,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49663,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49672_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__49672_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49673_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__49673_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__49681){
var vec__49682 = p__49681;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49682,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq49676){
var G__49678 = cljs.core.first(seq49676);
var seq49676__$1 = cljs.core.next(seq49676);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49678,seq49676__$1);
}));
...
var map__49722 = options;
var map__49722__$1 = (((((!((map__49722 == null))))?(((((map__49722.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49722.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49722):map__49722);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49722__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49722__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49722__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49722__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__49723 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49723,(5),null);
...
var o__48882__auto__ = f;
return (o__48882__auto__["getBasis"]).call(o__48882__auto__);
});
/**
...
}catch (e49745){var _e__48914__auto__ = e49745;
...
var G__49919 = (obj[cljs.core.first(path)]);
var G__49920 = cljs.core.rest(path);
obj = G__49919;
path = G__49920;
continue;
} else {
...
var _STAR_ = (function (accum,p__49792){
var vec__49793 = p__49792;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49793,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49793,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__49808){
var vec__49809 = p__49808;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49809,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49809,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49809,(2),null);
...
var post_process = (function (p__49826){
var vec__49828 = p__49826;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49828,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49828,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49818_SHARP_){
return (obj[cljs.core.first(p1__49818_SHARP_)]);
}),sorted_matches);

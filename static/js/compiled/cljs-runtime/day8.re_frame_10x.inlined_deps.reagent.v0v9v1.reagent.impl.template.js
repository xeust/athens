...
return (function() { 
var G__54376__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54376 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54384__i = 0, G__54384__a = new Array(arguments.length -  0);
while (G__54384__i < G__54384__a.length) {G__54384__a[G__54384__i] = arguments[G__54384__i + 0]; ++G__54384__i;}
  args = new cljs.core.IndexedSeq(G__54384__a,0,null);
} 
return G__54376__delegate.call(this,args);};
G__54376.cljs$lang$maxFixedArity = 0;
G__54376.cljs$lang$applyTo = (function (arglist__54385){
var args = cljs.core.seq(arglist__54385);
...
var G__54297 = o;
goog.object.set(G__54297,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54388__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__54389__i < G__54389__a.length) {G__54389__a[G__54389__i] = arguments[G__54389__i + 0]; ++G__54389__i;}
  args = new cljs.core.IndexedSeq(G__54389__a,0,null);
} 
return G__54388__delegate.call(this,args);};
G__54388.cljs$lang$maxFixedArity = 0;
G__54388.cljs$lang$applyTo = (function (arglist__54390){
var args = cljs.core.seq(arglist__54390);
return G__54388__delegate(args);
});
...
var G__54298 = props;
var G__54298__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54298,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__54298);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54298__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__54298__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.set_id_class((function (){var G__54299 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54299,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__54299;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v9v1$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__54308){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54309__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__54318_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_handle_change(this$,on_change,p1__54318_SHARP_);
}));
} else {
return null;
}
...
var vec__54340 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54340,(2),null);
...
var temp__5739__auto___54413 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___54413 == null)){
} else {
var key_54414 = temp__5739__auto___54413;
(jsprops.key = key_54414);
}
...
var temp__5739__auto___54420 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___54420 == null)){
} else {
var key_54422 = temp__5739__auto___54420;
(jsprops.key = key_54422);
}
...
var G__54344 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__54344) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.call(null,G__54344));
} else {
var temp__5739__auto___54440 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___54440 == null)){
} else {
var key_54441 = temp__5739__auto___54440;
(jsprops.key = key_54441);
}
...
var G__54346 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__54346)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__54346)){
return x;
} else {
...
var len__4736__auto___54443 = arguments.length;
var i__4737__auto___54444 = (0);
while(true){
if((i__4737__auto___54444 < len__4736__auto___54443)){
args__4742__auto__.push((arguments[i__4737__auto___54444]));

var G__54445 = (i__4737__auto___54444 + (1));
i__4737__auto___54444 = G__54445;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq54347){
...
var ctx = ({});
var vec__54359 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54359,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54359,(1),null);
...
var G__54362 = (cljs.core.count(argv) - first_child);
switch (G__54362) {
case (0):

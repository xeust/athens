...
return [(function (){var pred__54834 = cljs.core.instance_QMARK_;
var expr__54835 = reactive_val;
if(cljs.core.truth_((pred__54834.cljs$core$IFn$_invoke$arity$2 ? pred__54834.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__54835) : pred__54834.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__54835)))){
return "ra";
} else {
if(cljs.core.truth_((pred__54834.cljs$core$IFn$_invoke$arity$2 ? pred__54834.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__54835) : pred__54834.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__54835)))){
return "rc";
} else {
if(cljs.core.truth_((pred__54834.cljs$core$IFn$_invoke$arity$2 ? pred__54834.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__54835) : pred__54834.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__54835)))){
return "rx";
} else {
if(cljs.core.truth_((pred__54834.cljs$core$IFn$_invoke$arity$2 ? pred__54834.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__54835) : pred__54834.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__54835)))){
return "tr";
} else {
return "other";
}

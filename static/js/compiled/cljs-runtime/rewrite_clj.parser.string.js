...
if((c === "\n")){
var G__57047 = escape_QMARK_;
var G__57048 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__57047;
lines = G__57048;
continue;
} else {
buf.append(c);

var G__57049 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__57050 = lines;
escape_QMARK_ = G__57049;
lines = G__57050;
continue;
...
var G__57039 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__57039) : rewrite_clj.node.string_node.call(null,G__57039));
});
...
var G__57041 = cljs.core.re_pattern(regex);
var G__57042 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__57041,G__57042) : rewrite_clj.node.token_node.call(null,G__57041,G__57042));
});
